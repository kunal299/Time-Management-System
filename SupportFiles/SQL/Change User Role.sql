...
if @isManager=1 INSERT INTO  dbo.UserRolesMapping(UserID,RoleID,CreatedBy,ModifiedBy,CreatedOn,ModifiedOn)values(@ID,3,@ID,@ID,GetDate(),GetDate())
if @isEmployee=1 INSERT INTO  dbo.UserRolesMapping(UserID,RoleID,CreatedBy,ModifiedBy,CreatedOn,ModifiedOn)values(@ID,4,@ID,@ID,GetDate(),GetDate())
